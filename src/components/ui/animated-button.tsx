  ...
  "inline-flex items-center justify-center gap-2 whitespace-nowrap rounded-md text-sm font-medium transition-all duration-300 disabled:pointer-events-none disabled:opacity-50 [&_svg]:pointer-events-none [&_svg:not([class*='size-'])]:size-4 shrink-0 [&_svg]:shrink-0 outline-none focus-visible:border-ring focus-visible:ring-ring/50 focus-visible:ring-[3px] cursor-pointer",
  {
    variants: {
      variant: {
        ...
        // Slide effect
        slide:
          "bg-gradient-to-r from-primary to-red-600 text-white shadow-lg overflow-hidden relative hover:shadow-xl before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-white/20 before:to-transparent before:transition-all before:duration-500 hover:before:left-[100%]",
        ...
        // Flip effect
        flip: "bg-gradient-to-r from-primary to-secondary text-white shadow-lg hover:shadow-xl transform hover:rotateY-180 transition-all duration-500 preserve-3d",
        ...
        // Gradient shift
        gradientShift:
          "bg-gradient-to-r from-primary via-red-500 to-secondary text-white shadow-lg hover:shadow-xl bg-[length:200%_100%] hover:bg-right-bottom transition-all duration-500 hover:scale-105",
        ...
        // 3D effect
        threeDimensional:
          "bg-gradient-to-b from-primary to-red-700 text-white shadow-lg hover:shadow-xl transform hover:translate-y-[-2px] hover:shadow-2xl active:translate-y-[1px] active:shadow-md transition-all duration-200",

        // Loading effect
        loading:
          "bg-primary text-white shadow-lg hover:shadow-xl relative overflow-hidden before:absolute before:top-0 before:left-[-100%] before:w-full before:h-full before:bg-gradient-to-r before:from-transparent before:via-white/30 before:to-transparent before:animate-shimmer hover:before:animation-play-state-running",
