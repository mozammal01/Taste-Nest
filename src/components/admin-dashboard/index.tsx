        ...
        <div className="bg-white rounded-2xl p-6 border border-gray-100 shadow-sm hover:shadow-md hover:border-yellow-200 transition-all group">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className="text-3xl font-bold text-gray-900 mt-1">$45,890</p>
            </div>
          ...
          <div className="space-y-4">
            <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-900 text-sm">New order #1234 received</p>
            ...
            <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-900 text-sm">New user registered</p>
            ...
            <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-900 text-sm">Payment of $125.00 processed</p>
            ...
            <div className="flex items-center gap-4 p-3 rounded-xl hover:bg-gray-50 transition-colors">
              ...
              <div className="flex-1 min-w-0">
                <p className="text-gray-900 text-sm">Menu item updated</p>
