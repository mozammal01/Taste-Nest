  ...
  return (
    <div className="p-8">
      ...
      <div className="flex items-center justify-between mb-8">
        ...
        <button className="flex items-center gap-2 px-5 py-2.5 bg-primary hover:bg-primary/90 text-white rounded-xl transition-colors font-medium shadow-md shadow-primary/25">
